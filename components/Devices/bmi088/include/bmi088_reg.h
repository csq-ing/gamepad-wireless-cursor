/**
 * @file bmi088_reg.h
 * @brief BMI088 register map definitions (adapted from reference project)
 */
...
#define BMI088_ACCEL_CONFIG_ERROR    (1 << 2)
#define BMI088_FATAL_ERROR           (1 << 0)

#define BMI088_ACC_STATUS            0x03
#define BMI088_ACCEL_DRDY            (1 << 7)
...
#define BMI088_ACCEL_DRDY_INTERRUPT  (1 << 7)
...
#define BMI088_ACC_BWP_SHIFT         4
#define BMI088_ACC_OSR4              (0x0 << BMI088_ACC_BWP_SHIFT)
#define BMI088_ACC_OSR2              (0x1 << BMI088_ACC_BWP_SHIFT)
#define BMI088_ACC_NORMAL            (0x2 << BMI088_ACC_BWP_SHIFT)
#define BMI088_ACC_ODR_SHIFT         0
#define BMI088_ACC_12_5_HZ           (0x5 << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_25_HZ             (0x6 << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_50_HZ             (0x7 << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_100_HZ            (0x8 << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_200_HZ            (0x9 << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_400_HZ            (0xA << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_800_HZ            (0xB << BMI088_ACC_ODR_SHIFT)
#define BMI088_ACC_1600_HZ           (0xC << BMI088_ACC_ODR_SHIFT)

#define BMI088_ACC_RANGE             0x41
#define BMI088_ACC_RANGE_SHIFT       0
#define BMI088_ACC_RANGE_3G          (0x0 << BMI088_ACC_RANGE_SHIFT)
#define BMI088_ACC_RANGE_6G          (0x1 << BMI088_ACC_RANGE_SHIFT)
#define BMI088_ACC_RANGE_12G         (0x2 << BMI088_ACC_RANGE_SHIFT)
#define BMI088_ACC_RANGE_24G         (0x3 << BMI088_ACC_RANGE_SHIFT)

#define BMI088_INT1_IO_CTRL          0x53
#define BMI088_ACC_INT1_IO_ENABLE    (1 << 3)
...
#define BMI088_ACC_INT2_IO_ENABLE    (1 << 3)
...
#define BMI088_ACC_INT2_DRDY         (1 << 6)
#define BMI088_ACC_INT1_DRDY         (1 << 2)
...
#define BMI088_GYRO_DRDY             (1 << 7)

#define BMI088_GYRO_RANGE            0x0F
#define BMI088_GYRO_RANGE_SHIFT      0
#define BMI088_GYRO_2000             (0x0 << BMI088_GYRO_RANGE_SHIFT)
#define BMI088_GYRO_1000             (0x1 << BMI088_GYRO_RANGE_SHIFT)
#define BMI088_GYRO_500              (0x2 << BMI088_GYRO_RANGE_SHIFT)
#define BMI088_GYRO_250              (0x3 << BMI088_GYRO_RANGE_SHIFT)
#define BMI088_GYRO_125              (0x4 << BMI088_GYRO_RANGE_SHIFT)
...
#define BMI088_GYRO_DRDY_IO_BOTH      0x81

#define BMI088_GYRO_SELF_TEST         0x3C
#define BMI088_GYRO_RATE_OK           (1 << 4)
#define BMI088_GYRO_BIST_FAIL         (1 << 2)
#define BMI088_GYRO_BIST_RDY          (1 << 1)
#define BMI088_GYRO_TRIG_BIST         (1 << 0)
